<template>
  <!-- Hero/Banner -->
  <header
    class="flex flex-col items-center justify-center text-center px-4 py-20 animate-fade-in bg-[url(@/assets/images/products_banner_last.jpg)] bg-cover h-[800px] bg-center bg-no-repeat relative"
  >
  ...
  <main class="container mx-auto py-16 flex flex-col md:flex-row gap-10">
    <!-- Kategoriler -->
    <aside
      class="w-full md:w-64 bg-gray-50 rounded-xl shadow p-6 mb-8 md:mb-0 animate-slide-in-left"
      aria-label="Ürün kategorileri"
    >
      <h2
        class="text-lg font-bold tracking-widest mb-6 text-gray-800 uppercase"
      >
    ...
    <section class="flex-1" aria-labelledby="products-heading">
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
        ...
        >
          <div
            class="bg-gray-100 flex items-center justify-center h-56 w-full overflow-hidden"
          >
            <img
              :src="product.img"
          ...
          <div class="p-6 flex-1 flex flex-col justify-between">
            <h3
              class="font-extrabold text-lg text-gray-900 mb-4 uppercase tracking-wider"
            >
              {{ product.title }}
            </h3>
            <NuxtLink
...
.animate-slide-in-left {
  animation: slide-in-left 1s cubic-bezier(0.68, -0.55, 0.27, 1.55);
}
.animate-bounce-in {

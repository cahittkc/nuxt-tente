        ...
        products : [
            {
                ...
                images : [
                  '/images/blocjout_pergola/1.png',
                  '/images/blocjout_pergola/2.png',
                  '/images/blocjout_pergola/3.png',
                  '/images/blocjout_pergola/4.png',
                  '/images/blocjout_pergola/5.png',
                  '/images/blocjout_pergola/6.png',
                  '/images/blocjout_pergola/7.png',
                ],
                properties : [
              ...
              },
              {
                ...
                img: '/images/bioklimatik/bioklimatik_pergola1.png',
                images : [
                  '/images/bioklimatik/bioklimatik_pergola1.png',
                  '/images/bioklimatik/bioklimatik_pergola2.png',
                  '/images/bioklimatik/bioklimatik_pergola3.png',
                  '/images/bioklimatik/bioklimatik_pergola4.png',
                  ],
                properties : [
              ...
              },
              {
                ...
                img: '/images/cati_zip/cati_zip_perde.png',
                images : [
                  '/images/cati_zip/cati_zip_perde.png',
                  '/images/cati_zip/cati_zip_perde1.png',
                  '/images/cati_zip/cati_zip_perde2.png',
                  '/images/cati_zip/cati_zip_perde3.png',
                ],
                properties : [
              ...
              },
              {
                ...
                img: '/images/dikey_zip/dikey_zip1.png',
                images : [
                  '/images/dikey_zip/dikey_zip1.png',
                  '/images/dikey_zip/dikey_zip2.png',
                  '/images/dikey_zip/dikey_zip3.png',
                  '/images/dikey_zip/dikey_zip4.png',
                  '/images/dikey_zip/dikey_zip5.png',
                ],
                properties : [
              ...
              },
              {
                ...
                img: '/images/semsiye_sezlong/7.png',
                images : [
                  '/images/semsiye_sezlong/3.png',
                  '/images/semsiye_sezlong/5.png',
                  '/images/semsiye_sezlong/6.png',
                  '/images/semsiye_sezlong/7.png',
                  '/images/semsiye_sezlong/8.png',
                  '/images/semsiye_sezlong/10.png',
                ],
                properties : [
              ...
              },
              {
                ...
                images : [
                  '/images/kasetli_tente/kasetli_tente1.png',
                  '/images/kasetli_tente/kasetli_tente2.png',
                  '/images/kasetli_tente/kasetli_tente3.png',
                  '/images/kasetli_tente/kasetli_tente4.png',
                ],
                properties : [
              ...
              },
              {
                ...
                images : [
                    '/images/giyotin/giyotin_cam1.png',
                    '/images/giyotin/giyotin_cam2.png',
                    '/images/giyotin/giyotin_cam3.png',
                    '/images/giyotin/giyotin_cam4.png',
                    '/images/giyotin/giyotin_cam5.png',
                    '/images/giyotin/giyotin_cam6.png',
                ],
                properties : [
              ...
              },
              {
                ...
                images : [
                  '/images/branda/branda_uygulamasi1.png',
                  '/images/branda/branda_uygulamasi2.png',
                  '/images/branda/branda_uygulamasi3.png',
                ],
                properties : [
              ...
              },
              {
                ...
                img: '/images/cadir/cadir1.png',
                images : [
                  '/images/cadir/cadir1.png',
                  '/images/cadir/cadir2.png',
                  '/images/cadir/cadir3.png',
                  '/images/cadir/cadir4.png',
                  '/images/cadir/cadir5.png',
                  '/images/cadir/cadir6.png',
                  '/images/cadir/cadir7.png',
                ],
                properties : []
              },
              {
                ...
                img: '/images/karoser/karoser_uygulama1.png',
                images : [
                  '/images/karoser/karoser_uygulama1.png',
                  '/images/karoser/karoser_uygulama2.png',
                  '/images/karoser/karoser_uygulama3.png',
                ],
                properties : [
              ...
              },
              {
                ...
                img: '/images/mafsalli/mafsalli_tente1.png',
                images : [
                  '/images/mafsalli/mafsalli_tente1.png',
                  '/images/mafsalli/mafsalli_tente2.png',
                  '/images/mafsalli/mafsalli_tente3.png',
                  '/images/mafsalli/mafsalli_tente4.png',
                  '/images/mafsalli/mafsalli_tente5.png',
                ],
                properties : [
              ...
              },
              {
                ...
                img: '/images/wintent/wintent_tente1.png',
                images : [
                  '/images/wintent/wintent_tente1.png',
                  '/images/wintent/wintent_tente2.png',
                  '/images/wintent/wintent_tente3.png',
                  '/images/wintent/wintent_tente4.png',
                  '/images/wintent/wintent_tente5.png',
                ],
                properties : [
              ...
              },
              {
                ...
                images : [
                  '/images/perde_cam/perde_cam1.png',
                  '/images/perde_cam/perde_cam2.png',
                  '/images/perde_cam/perde_cam3.png',
                  '/images/perde_cam/perde_cam4.png',
                  '/images/perde_cam/perde_cam5.png',
                ],
                properties : [
              ...
              },
              {
                ...
                img: '/images/dorse/karoser_branda1.jpg',
                properties :[
                ...
                images : [
                  '/images/dorse/karoser_branda1.jpg',
                  '/images/dorse/karoser_branda2.jpg',
                  '/images/dorse/karoser_branda3.jpg',
                  '/images/dorse/karoser_branda4.jpg',
                  '/images/dorse/karoser_branda5.jpg',
                  '/images/dorse/karoser_branda6.jpg',
                  '/images/dorse/karoser_branda7.jpg',
                  '/images/dorse/karoser_branda8.jpg',
                  '/images/dorse/karoser_branda9.jpg',
                  '/images/dorse/karoser_branda10.jpg',
                ]  
              }
        ]
    }),
